...
for dir in openfmr-core openfmr-module-cr openfmr-module-hfr openfmr-module-lmis openfmr-module-hwr openfmr-module-ts openfmr-module-shr; do
  if [ -d "$dir" ]; then
    echo "Stopping $dir..."
...
for dir in openfmr-module-cr openfmr-module-hfr openfmr-module-lmis openfmr-module-hwr openfmr-module-ts openfmr-module-shr; do
